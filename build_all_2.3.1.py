...
# -*- coding: utf-8 -*-
"""
统一打包脚本 - 自动检测系统并生成对应版本的应用 (v2.3.1)
...
def build_application():
    ...
    # 打包2.3.1版本
    main_file = '交叉口交通流量流向可视化工具2.3.1.py'
    ...
    # 构建 PyInstaller 命令
    # 2.3.1版本需要包含update_checker.py模块
    cmd = [
        sys.executable, '-m', 'PyInstaller',
        '--clean',
        '--noconfirm',
        '--onefile',
        '--name', '交叉口交通流量流向可视化工具2.3.1',
        main_file,
    ...
    if system == 'Windows':
        version_file = 'version_info_2.3.1.txt'
...
def verify_build():
    ...
    if system == 'Windows':
        exe_path = os.path.join('dist', '交叉口交通流量流向可视化工具2.3.1.exe')
    else:
        exe_path = os.path.join('dist', '交叉口交通流量流向可视化工具2.3.1')
...
def show_summary(exe_path, system_info):
    ...
    if exe_path and os.path.exists(exe_path):
        ...
        if system == 'Windows':
            ...
            print("\n使用方法:")
            print(f"  1. 找到文件: {exe_path}")
            print("  2. 在终端中运行: ./dist/交叉口交通流量流向可视化工具2.3.1")
            print("  3. 或右键点击 -> 打开")
            print("\n如果提示'无法打开'，请运行:")
...
def main():
    """主函数"""
    print_header("交叉口交通流量流向可视化工具 v2.3.1 - 统一打包脚本")
